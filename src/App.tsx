      ...
      <div className="App">
        ...
        <main className="App-main">
          <div className="App-hero">
            ...
            <small>Digital collectibles from The Nordic Bible Museum</small>
          </div>
          <iframe id="opensea-iframe" title="Embedded OpenSea Marketplace" src={embeddedUrl} width='100%' height='100%' frameBorder='0' allowFullScreen style='min-height: 95vh;'></iframe>
        </main>
